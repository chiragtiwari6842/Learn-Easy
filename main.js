...
scheduleButton.addEventListener("click", async () => {
    ...
    if (!topic) {
        ...
        try {
            const response = await fetch("http://192.168.0.103:5000/schedule_class", {
                method: "POST",
                headers: {
            ...
            console.log(link);
            const detailsResponse = await fetch("http://192.168.0.103:5000/get_class_details", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            localStorage.setItem("questions", JSON.stringify(detailsData.questions));
            localStorage.setItem("content", detailsData.content);
